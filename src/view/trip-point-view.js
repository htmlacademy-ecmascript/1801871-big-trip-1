...
const createTripPointTemplate = (point, offers, destination,) =>
  `         <li class="trip-events__item">
              <div class="event">
                <time class="event__date" datetime="${formatDate(point.dateFrom, 'YYYY-MM-DD')}">${formatDate(point.dateFrom, 'MMM DD')}</time>
                ...
                <div class="event__schedule">
                  <p class="event__time">
                    <time class="event__start-time" datetime="${point.dateFrom}">${formatDate(point.dateFrom, 'HH:mm')}</time>
                    &mdash;
                    <time class="event__end-time" datetime="${point.dateTo}">${formatDate(point.dateTo, 'HH:mm')}</time>
                  </p>
